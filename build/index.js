...
var _stdev = __webpack_require__(5);
...
var SparklinesReferenceLine = function (_React$Component) {
    ...
    _createClass(SparklinesReferenceLine, [{
        ...
        value: function render() {
            ...
            var data = type == 'custom' ? [value] : dataProcessing[type](ypoints);
            var y = (0, _dataToPoints2.default)({ data: data, limit: limit, width: width, height: height, margin: margin, max: max, min: min })[0].y;
...
var _stdev2 = __webpack_require__(5);
