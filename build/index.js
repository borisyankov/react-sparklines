...
var Sparklines = function (_PureComponent) {
    ...
    _createClass(Sparklines, [{
        ...
        value: function render() {
            ...
            var max = typeof forceMax === 'number' ? forceMax : (0, _max2.default)(data);
            var min = typeof forceMin === 'number' ? forceMin : (0, _min2.default)(data);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.Children.map(this.props.children, function (child) {
                    return _react2.default.cloneElement(child, { data: data, points: points, width: width, height: height, margin: margin, max: max, min: min });
                })
            );
        }
    }]);
    ...
    _createClass(SparklinesReferenceLine, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                height = _props$height === undefined ? 1 : _props$height,
                max = _props.max,
                min = _props.min;
            ...
            var y = type == 'custom' ? valueToY(value, height, margin, max, min) : dataProcessing[type](ypoints);
